...
@section('page-title', 'Tambah Prodi Baru')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-neutral-500 md:ms-2">Tambah Baru</span>
                </div>
            </li>
        </ol>
    </nav>

    <h1 class="text-2xl font-bold text-neutral-800 mt-4 mb-6">Tambah Program Studi Baru</h1>
